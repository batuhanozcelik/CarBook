...
namespace CarBook.WebUI.Controllers
{
    ...
    public class AdminCarController : Controller
    {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessageBrands = await client.GetAsync("https://localhost:7073/api/Brands");
            var jsonDataBrands = await responseMessageBrands.Content.ReadAsStringAsync();
            var valuesBrand = JsonConvert.DeserializeObject<List<ResultBrandDto>>(jsonDataBrands);
